...
public class MuPDFPageView extends PageView {
	...
	@Override
	protected Bitmap drawPage(int page,int sizeX, int sizeY, int patchX, int patchY,
			int patchWidth, int patchHeight) {
		return mCore.drawPage(page, sizeX, sizeY, patchX, patchY, patchWidth, patchHeight);		
	}
	@Override
