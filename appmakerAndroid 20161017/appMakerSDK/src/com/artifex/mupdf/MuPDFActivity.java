...
*/
		...
		LinearLayout opertionLay = new LinearLayout(this);
		MarginLayoutParams lp = new MarginLayoutParams(MarginLayoutParams.FILL_PARENT,MarginLayoutParams.FILL_PARENT);
		layout.addView(opertionLay,lp);
