...
import com.hl.android.view.widget.ImageCacheWidget;
import com.hl.android.view.widget.image.CommonImageView;

public class HLViewFlipper extends FrameLayout implements Component,
		ComponentPost {
	ComponentEntity entity;
	ArrayList<Bitmap> bitmapList = new ArrayList<Bitmap>();
	ImageCacheWidget imageCacheWidget = null;

	public HLViewFlipper(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
	}

	public HLViewFlipper(Context context, ComponentEntity entity) {
		super(context);
		this.entity = entity;
	...
	private void loadBitmap() {
		...
		ArrayList<String> sourceIDS = ((MoudleComponentEntity) this.entity)
				.getSourceIDList();
		ArrayList<CommonImageView> imageViewList = new ArrayList<CommonImageView>();
		if (null != sourceIDS && sourceIDS.size() > 0) {
			for (int i = 0; i < sourceIDS.size(); i++) {
				CommonImageView imageView = new CommonImageView(
						this.getContext());
		...
		imageCacheWidget = new ImageCacheWidget(this.getContext(), sourceIDS,
				imageViewList);
	}
	...
	private Bitmap getBitMap(String localSourceID) {
	...
	void showOnly(int childIndex) {
		...
		for (int i = 0; i < count; i++) {
			...
			if (i == childIndex) {
				imageCacheWidget.loadBitmap(childIndex);
