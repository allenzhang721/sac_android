...
public class ComponentMoudleHelper {
	static HashMap<String,String> moduleMap = new HashMap<String,String>();
	static {
	...
	public static Component getComponent(String moudleId, Class[] argsType,
			Object[] argsValue) {
		Component component = null;
		try {
			if (moudleId.equals("moduleuicomponent.photo.multipleleaf::HLHorSliderImageUIComponent")) {

				component = (Component) ReflectHelp
						.newInstance(
								"com.hl.android.view.component.moudle.HLViewFlipperInter",
								argsType, argsValue);
				return component;

			} else if (moudleId.contains("HL360RotatingImageUIComponent")) {
				component = (Component) ReflectHelp
						.newInstance(
								"com.hl.android.view.component.moudle.HL3DViewFlipper",
								argsType, argsValue);
			}else if (moudleId.contains("moduleuicomponent.photo.multipleleaf::HLVerSliderImageUIComponent")) {
				component = (Component) ReflectHelp
						.newInstance(
								"com.hl.android.view.component.moudle.HLViewFlipperVerticleInter",
								argsType, argsValue);

			}else if(moudleId.contains("moduleuicomponent.module.magazine::HLCarouselImageUIComponent")){
				component = (Component) ReflectHelp
						.newInstance(
								"com.hl.android.view.component.moudle.HLCarouselImageUIComponent",
								argsType, argsValue);
			}else if(moudleId.contains("moduleuicomponent.multiMedia.game.puzzleGame::HLPuzzleGameUIComponent")){
				component = (Component) ReflectHelp
						.newInstance(
								"com.hl.android.view.component.moudle.HLPuzzleGameUIComponent",
								argsType, argsValue);

			}else if(moudleId.contains("moduleuicomponent.exam::HLExamUIComponent")){
				component = (Component) ReflectHelp
						.newInstance(
								"com.hl.android.view.component.moudle.QuestionComponent",
								argsType, argsValue);
 
			}else if(moudleId.contains("moduleuicomponent.camera::HLCameraUIComponent")){
				component = (Component) ReflectHelp
						.newInstance(
								"com.hl.android.view.component.moudle.HLCameraUIComponent",
								argsType, argsValue);
 
			}else if(moudleId.contains("moduleuicomponent.sliderhand::HLSliderSliceComponent")){
				component = (Component) ReflectHelp
						.newInstance(
								"com.hl.android.view.component.moudle.HLSliderSliceComponent",
								argsType, argsValue);
				...
				component = (Component) ReflectHelp
						.newInstance(
								"com.hl.android.view.component.moudle.HLMouseCatalogVScrollUIComponent",
								argsType, argsValue);
 
			}else if(moudleId.contains("moduleuicomponent.photo.signleaf.panoroma::HLPanoromaUIComponent")){
				component = (Component) ReflectHelp
						.newInstance(
								"com.hl.android.view.component.moudle.HLPanoromaUIComponent",
								argsType, argsValue);
 
			}else if(moudleId.contains("moduleuicomponent.mousescroll::HLMouseVerInteractScrollUIComponent")){
				component = (Component) ReflectHelp
						.newInstance(
								"com.hl.android.view.component.moudle.HLMouseVerInteractScrollUIComponent",
								argsType, argsValue);
 
			}
			else{
				if(moduleMap.containsKey(moudleId)){
					component = (Component) ReflectHelp
							.newInstance(
									moduleMap.get(moudleId),
									argsType, argsValue);
				}else{
