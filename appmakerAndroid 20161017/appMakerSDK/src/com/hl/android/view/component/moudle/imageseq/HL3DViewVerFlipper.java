...
public class HL3DViewVerFlipper extends ImageView implements Component,
		ComponentPost {
	...
	public HL3DViewVerFlipper(Context context, ComponentEntity entity) {
		super(context);
		this.entity = entity;
	...
	public void setImageBitmapOnly(int index) {
		...
		this.currentBitmap = BitmapUtils.getBitMap(sourceIDS.get(index),getContext(),getLayoutParams().width,getLayoutParams().height);
		if (null != this.currentBitmap) {
