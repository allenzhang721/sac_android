...
public class ScrollTextViewComponent extends ScrollView implements Component{
	...
	public ScrollTextViewComponent(Context context, ComponentEntity entity) {
		super(context);
		this.entity = entity;
	...
	@Override
	public void load() {
		// TextViewComponent textC = new
		// TextViewComponent(this.getContext(),this.entity);
		// textC.load();
	...
	public void setFontSize(String fontSize){
		...
		scrollTo(0, 0);
		this.layout(getEntity().x,getEntity().y,getEntity().x
