...
public class ImageLoaderTask extends AsyncTask<String, Bitmap, Bitmap> {
	...
	private int mResizeWidth, mResizeHeight;

	public ImageLoaderTask(ImageView imageView, Context context, String fileID,
	...
	public void load(InputStream is) {
		...
		imageViewReference.get().setImageBitmap(
				Bitmap.createScaledBitmap(mBitmap, mResizeWidth, mResizeHeight,
						true));
	}
