...
public class Galley3D4ShowSnaps extends AbstractGalley {
	...
	private int mMaxRotationAngle = 55;// 最大转动角度
...
//	}
	...
	protected Bitmap getBitmap(String resourceID, int width, int height) {
		Bitmap b = BitmapUtils.getBitMap(resourceID, mContext,width,height);
		return ImageManager.createReflectionImageWithOrigin(b, 0.2f);
//		// 倒影图和原图之间的距离
...
//		return layoutParams1;
	...
	protected void setWaitLoad(ImageView img) {
		Bitmap b = BitmapFactory.decodeResource(getResources(), R.drawable.scene_ic_loading_invert);
