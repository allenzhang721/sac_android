...
//	        try {
//	            byte[] key = "c1f286bf".getBytes();
//	            byte[] iv = "chengxingyu".getBytes();
//	            byte[] data = encrypt("chenxingyu".getBytes(), key);
//	            
////	            System.out.println(Base64.encode(data));
//	            System.out.println(new String(decrypt(Base64.decode("jI2DdWnYQG0nNo1fvAfzxA=="), key)));
////	            System.out.print("CBC mode:");
////	            data = CBCEncrypt("cbc mode test".getBytes(), key, iv);
////	            System.out.println(new String(CBCDecrypt(data, key, iv)));
//	            
//	        } catch (Exception e) {
//	            e.printStackTrace();
//	        }
